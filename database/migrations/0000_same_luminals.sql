...
ALTER TABLE "organization_module_entitlement" ADD CONSTRAINT "organization_module_entitlement_organization_id_organization_id_fk" FOREIGN KEY ("organization_id") REFERENCES "public"."organization"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "organization_module_entitlement" ADD CONSTRAINT "organization_module_entitlement_updated_by_user_id_user_id_fk" FOREIGN KEY ("updated_by_user_id") REFERENCES "public"."user"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "restaurant_order_item" ADD CONSTRAINT "restaurant_order_item_kitchen_ticket_id_restaurant_kitchen_ticket_id_fk" FOREIGN KEY ("kitchen_ticket_id") REFERENCES "public"."restaurant_kitchen_ticket"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "restaurant_order_item_modifier" ADD CONSTRAINT "restaurant_order_item_modifier_organization_id_organization_id_fk" FOREIGN KEY ("organization_id") REFERENCES "public"."organization"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "restaurant_order_item_modifier" ADD CONSTRAINT "restaurant_order_item_modifier_order_item_id_restaurant_order_item_id_fk" FOREIGN KEY ("order_item_id") REFERENCES "public"."restaurant_order_item"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "restaurant_order_item_modifier" ADD CONSTRAINT "restaurant_order_item_modifier_modifier_product_id_product_id_fk" FOREIGN KEY ("modifier_product_id") REFERENCES "public"."product"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
