...
export function PosHeader({
	...
	return (
		<header className="z-10 shrink-0 border-b border-zinc-800 bg-[var(--color-carbon)] px-3 py-3 md:px-4 md:py-2">
			<div className="flex min-h-10 flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
				<div className="flex min-w-0 flex-1 flex-col gap-3 md:flex-row md:items-center">
					<div className="flex shrink-0 items-center gap-2 text-sm whitespace-nowrap">
						...
						<span className="text-zinc-400 text-xs px-1.5 py-0.5 bg-zinc-800 rounded-md">
