...
interface PrinterStatusSnapshot {
  coverOpened: boolean;
  online: boolean;
  paperLoaded: boolean;
  paperLow: boolean;
...
interface PosPrinterRuntimeState {
...
interface ConnectedDevicePayload {
...
class PosPrinterManager {
  ...
  private readonly autoReconnectAttempted = new Set<string>();
