...
export function CartItemCardV2({
  ...
  return (
    <div className="group rounded-xl border border-[rgba(255,255,255,0.08)] bg-[#151515] p-3 transition-colors hover:border-[rgba(255,255,255,0.15)]">
      <div className="flex flex-col gap-2">
            ...
            {item.modifiers.length > 0 && (
              <div className="mt-1 flex flex-wrap gap-1.5">
                {item.modifiers.map((modifier) => (
                  <span
                    className="rounded border border-[rgba(255,255,255,0.08)] bg-[rgba(255,255,255,0.05)] px-1.5 py-0.5 text-[#a0a0a0] text-[10px]"
        ...
        <div className="mt-1">
          <label
            className="text-[#6b6b6b] text-[10px]"
          ...
          <div className="relative mt-1">
            ...
            <Input
              autoComplete="off"
              className="h-9 touch-manipulation border-[rgba(255,255,255,0.08)] bg-[rgba(255,255,255,0.03)] pl-6 text-base text-white focus-visible:border-[#dfff06]/30 focus-visible:ring-[#dfff06]/10 md:h-8 md:text-xs"
        ...
        <div className="mt-1 flex items-center justify-between">
          <div className="flex items-center rounded-lg border border-[rgba(255,255,255,0.08)] bg-[rgba(255,255,255,0.03)]">
            <button
