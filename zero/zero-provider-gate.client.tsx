...
import { ZentroZeroProvider } from "@/zero/zero-provider.client";
...
export function ZeroProviderGate({
  ...
  if (allowAnonymous) {
    return (
      <ZentroZeroProvider cacheURL={cacheURL} mode="optional" userID={null}>
        {children}
      </ZentroZeroProvider>
    );
  }
